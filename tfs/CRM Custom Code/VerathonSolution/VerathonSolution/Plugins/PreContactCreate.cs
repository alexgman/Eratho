// <copyright file="PreContactCreate.cs" company="Green Beacon Solutions">
// Copyright (c) 2012 All Rights Reserved
// </copyright>
// <author>Green Beacon Solutions</author>
// <date>9/22/2012 1:43:00 PM</date>
...
namespace VerathonSolution.Plugins
{
    ...
    public class PreContactCreate: Plugin
    {
        ...
        public PreContactCreate(string unsecure, string secure)
        ...
        protected void ExecutePreContactCreate(LocalPluginContext localContext)
        {
            ...
            try
            {
                ...
                if (!target.Contains("vth_contactnumber"))
                {
                    ...
                    target["vth_contactnumber"] = GBSNextId.GetNextIntegerId(sequenceId, localContext.OrganizationService).ToString();
                }
