// <copyright file="PreCompanyCreate.cs" company="Green Beacon Solutions">
// Copyright (c) 2012 All Rights Reserved
// </copyright>
// <author>Green Beacon Solutions</author>
// <date>9/21/2012 1:35:37 PM</date>
// <summary>Implements the PreCompanyCreate Plugin.</summary>
// <auto-generated>
...
namespace VerathonSolution.Plugins
{
    ...
    /// <summary>
    /// PreCompanyCreate Plugin.
    /// </summary>    
    public class PreCompanyCreate: Plugin
    {
        public string unsecureConfig = "";

        /// <summary>
        /// Initializes a new instance of the <see cref="PreCompanyCreate"/> class.
        /// </summary>
        ...
        public PreCompanyCreate(string unsecure, string secure)
            : base(typeof(PreCompanyCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Create", "account", new Action<LocalPluginContext>(ExecutePreCompanyCreate)));
        ...
        /// </remarks>
        protected void ExecutePreCompanyCreate(LocalPluginContext localContext)
        {
            ...
            try
            {
                ...
                if (!target.Contains("accountnumber"))
                {
                    ...
                    target["accountnumber"] = GBSNextId.GetNextIntegerId(sequenceId, localContext.OrganizationService).ToString();
                }
